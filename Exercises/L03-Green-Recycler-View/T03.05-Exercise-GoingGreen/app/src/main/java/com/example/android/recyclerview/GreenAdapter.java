...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int bgColorForViewHolder = ColorUtils.getViewHolderBackgroundColorFromInstance(context, viewHolderCount);
        viewHolder.itemView.setBackgroundColor(bgColorForViewHolder);

        // TODO (15) Increment viewHolderCount and log its value
        viewHolderCount++;
        Log.d(TAG, "onCreateViewHolder: number of ViewHolders: "+ viewHolderCount);
